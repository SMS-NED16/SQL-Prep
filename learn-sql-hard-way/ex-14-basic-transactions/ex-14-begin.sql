...
/*
	 Putting a ROLLBACK here means that any code in the transaction boundary
	 between BEGIN and ROLLBACK will be reverted. Nothing will have changed in the db.
*/
ROLLBACK;