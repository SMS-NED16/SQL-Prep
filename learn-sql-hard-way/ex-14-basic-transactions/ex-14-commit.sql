/* 
	Places a 'boundary' around the following SQL statements so that 
	we can either COMMIT them or ROLLBACK if something goes wrong.
*/
BEGIN;
...
/* 
	Assuming no errors have been made in the SQL statements between 
	the following COMMIT and the first BEGIN, the changes will persist.
	New data will have been added to the database.  
*/
COMMIT;
